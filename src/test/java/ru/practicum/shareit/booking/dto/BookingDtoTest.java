...
class BookingDtoTest {
    ...
    void testSerialize() {
        ...
        assertThat(result).extractingJsonPathStringValue("$.status").isEqualTo(BOOKING_DTO.getStatus().toString());
    ...
    void testDeserialize() {
        ...
        assertThat(result.getStatus()).isEqualTo(BookingStatus.valueOf("WAITING"));
